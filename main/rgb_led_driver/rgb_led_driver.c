...
static const rgb_color_t color_rgb_map[RGB_COLOR_MAX] = {
	[RGB_COLOR_RED] = {255, 0, 0},	 [RGB_COLOR_BLUE] = {0, 0, 255},
	[RGB_COLOR_GREEN] = {0, 255, 0}, [RGB_COLOR_WHITE] = {255, 255, 255},
	[RGB_COLOR_OFF] = {0, 0, 0},
};
...
static RGB_example_color_t RGB_color = RGB_COLOR_OFF;
...
void _set_single_led_color(RGB_example_color_t color, uint32_t led_index) {
	...
	ESP_ERROR_CHECK(led_strip_set_pixel(led_strip, led_index, current_color.r,
